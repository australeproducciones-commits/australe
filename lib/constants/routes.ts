export const ROUTES = {
  ...
  tiendaEvento: (eventSlug: string) => `/tienda?evento=${encodeURIComponent(eventSlug)}`,
  tiendaCarrito: "/tienda/carrito",
  tiendaCheckout: "/tienda/checkout",
  tiendaPagoExito: "/tienda/pago/exito",
  tiendaPagoPendiente: "/tienda/pago/pendiente",
  tiendaPagoError: "/tienda/pago/error",
  miCuentaPedidos: "/mi-cuenta/pedidos",
  miCuentaPedido: (id: string) => `/mi-cuenta/pedidos/${id}`,
  login: "/login",
  miCuenta: "/mi-cuenta",
  ...
  adminTiendaPedidos: "/admin/tienda/pedidos",
