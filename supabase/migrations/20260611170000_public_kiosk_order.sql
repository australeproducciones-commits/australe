-- =============================================================================
-- Australe Producciones · ETAPA C.3.1 — Preventa pública de consumisiones
-- Requiere: event_kiosk_foundation, manual_kiosk_order, manage_kiosk_orders
-- =============================================================================
...
COMMENT ON FUNCTION public.create_public_kiosk_order IS
  'Reserva pública de consumisiones: valida evento publicado y preventa, crea orden source=public.';

REVOKE ALL ON FUNCTION public.create_public_kiosk_order(
